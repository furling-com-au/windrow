  ...
  {#if app.viewMode === "advanced"}
    ...
    {#if showAssump}
      <div class="assump">
        ...
        <label title="A17: opening stocks are a lower bound, not a stocktake — the old crop the ports shipped out in Oct-Nov, which misses whatever was still in the shed. Scale them to test how much that uncertainty matters. Scaled-up stock is capped at each site's storage capacity: 2023/24 at ×2 asks Port Lincoln to open 162% full, and the surplus above capacity is dropped rather than seeded.">
